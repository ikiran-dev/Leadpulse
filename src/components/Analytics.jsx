    ...
    <div className="w-full bg-gray-300 py-16 px-4">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center">
          <p className="text-blue-950 font-bold; text-2xl"> {analytics3} </p>
          <h1 className="md:text-4xl sm:text-3xl text-2xl font-bold py-2 ">
            {analytics1}
          </h1>
          <p>{analytics2}</p>
          <button className="bg-black text-gray-300 w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3 ">
            Get Started
          </button>
        </div>
      </div>
