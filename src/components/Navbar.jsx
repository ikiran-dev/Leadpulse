...
function Navbar({ company, navigation }) {
      ...
      <div
        className={
          nav
            ...
            : "fixed left-[-100%] top-0 w-[60%] ease-in-out duration-500"
        }
      >
        <h1 className="w-full text-3xl font-bold text-[#00df9a] m-5">
          {company}.
        </h1>
        <ul className=" p-4 uppercase">
          ...
          <li className="p-4 ">Contact</li> */}
          {navigation.map((item, index) => (
            <li key={index} className="p-4 border-b border-b-gray-900  }">
              {item}
            </li>
          ))}
        </ul>
